...
import json
# ✅ 替换为你的一批测试请求体（多个 URL）
JSON_PAYLOADS = [{"url":"https://csde-file.trinablue.com/prod/rsbu-mdm-contract-ps-api/20250318/F053943EE77A499FA4D4D84E8FC0CF9C_67d906c0e4b054f2346cd051.xlsx"}
...
START =  time.time()
ENDPOINT = "http://10.60.200.100:1234/items/"
CONCURRENT_LIMIT = 30
RESULT_DIR = "results"
